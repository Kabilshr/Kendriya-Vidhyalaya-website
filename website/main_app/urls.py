...
urlpatterns = [
    ...
    path('Mandatory_Public_Disclosure', views.disclosure, name='disclosure'),
    path("CBSE_Affiliation_Report", views.report, name='report'),
    path("result", views.result, name="result"),
    path("Teacher_Achiever", views.teacher_achievement,name="teacher_achievement"),
